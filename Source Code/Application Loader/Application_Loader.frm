...
For outerloop = testmajor To testmajor + 10
For innerloop = 0 To testminor + 10
    strKeyQuery = regDoes_Key_Exist(lngRootKey, "SOFTWARE\Microsoft\.NETFramework\v" & outerloop & "." & innerloop)
    If strKeyQuery = True Then
        proceed = True
        major = True
        minor = True
    ...
    strKeyQuery = regDoes_Key_Exist(lngRootKey, "SOFTWARE\Microsoft\NET Framework\v" & outerloop & "." & innerloop & "." & application_buildnumber)
    If strKeyQuery = True Then
        proceed = True
        major = True
        minor = True
